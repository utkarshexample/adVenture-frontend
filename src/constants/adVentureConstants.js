...
export const PRIMARY = '#636fff';
export const PRIMARY_HOVER = '#4f58e6';
export const SECONDARY_CYAN = '#22d3ee';
export const SECONDARY_VIOLET = '#a78bfa';
export const PRIMARY_RGB = '99, 111, 255';

export const LOADING_ROTATE_MS = 1500;
